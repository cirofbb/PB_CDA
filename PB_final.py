...
@st.cache_data
def load_data():
    data = pd.read_csv('./Data/lixo.csv')
    data_dom = pd.read_csv('./Data/dados_mesclados_dom.csv')
    data_pub = pd.read_csv('./Data/dados_mesclados_pub.csv')
    data_comp = pd.read_csv('./Data/data_comp.csv')
...
@st.cache_data
def load_txt_file():
    with open('./Data/conteudo_reciclagem.txt', 'r', encoding='utf-8') as file:
        content = file.read()
    return content
